...
public interface constants {
    public static String[] AdminMenu = {"-----------------------------------------","Admin Menu",
            ...
            "-----------------------------------------","Enter your choice: "};
    public static String[] UserMenu = {"\nUser Menu", "1. Book a Ticket", "2. View My Bookings",
            "3. Logout", "Enter your choice: "};
    public static String[] RegisterMenu = {"-----------------------------------------",
            "You are in Register Menu : ", "Enter username:", "Enter password:", "Enter email:",
            "-----------------------------------------"};
    public static String[] LoginMenu = {"-----------------------------------------",
            "You are in Login Menu :", "Enter username: ", "Enter password: ",
            "-----------------------------------------"};
    public static String[] WelcomeMenu = {"1. Login", "2. Register",
